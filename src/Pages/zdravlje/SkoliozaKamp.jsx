...
const SkoliozaKamp = () => {
  return (
    <section className="relative min-h-screen font-oswald">
      <div className="flex px-6 sm:px-20 py-20 max-lg:flex-col max-lg:gap-16">
        <div className="basis-1/2 text-2xl py-2 px-3">
          <h3 className="text-red_preh font-semibold text-2xl underline mb-5">
            Skolioza kamp Biograd - 2025.
          </h3>
          <div className="flex flex-col gap-10">
            <p>
              Uz stručno vodstvo, vježbe prilagođene vašim potrebama i prekrasan
              ambijent mora, ovo je savršena prilika za rad na sebi, druženje i
              edukaciju.
            </p>
            <p>
        ...
        <div className="lg:max-w-[50%] basis-1/2 py-2 px-3">
          <Swiper
      ...
      <div
        id="tekst"
        className="bg-slate-100 px-6 py-20 rounded-xl shadow-lg font-oswald text-xl lg:text-2xl text-justify text-gray-800 leading-relaxed space-y-5"
      >
        <p>
          Skolioza je posturalna deformacija kralježnice koja često uzrokuje
          bolove, loše držanje i smanjenu funkcionalnost tijela. Naš cilj je
          pružiti cjelovitu podršku svima koji se bore s ovim izazovom kroz
          znanje, pokret i zajedništvo.
        </p>
        <p>
          U sklopu{" "}
          ...
          edukaciju i savjete, a sve to uz predivno more i pozitivnu atmosferu.
        </p>
        <p>
          Fokusirani smo na{" "}
          <span className="text-red_preh font-semibold">
