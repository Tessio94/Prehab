	...
	useEffect(() => {
		const syncHeights = () => {
			...
			if (window.innerWidth >= 1280) {
				const leftHeight = containerLeft.current.offsetHeight;
				containerRight.current.style.maxHeight = `${leftHeight}px`;
				containerRight.current.style.maxWidth = `${leftHeight * 0.8}px`;
			} else {
				containerRight.current.style.maxHeight = "unset";
				containerRight.current.style.maxWidth = "unset";
			}
		};
	...
	return (
		<>
			...
			<section className="relative min-h-screen font-oswald" id="clanak-top">
				<div className="flex px-4 sm:px-10 lg:px-6 xxl:px-20 py-20 max-xl:flex-col max-xl:gap-16 xxl:gap-16">
					<div
						className="max-lg:w-full max-xl:w-[70%] xl:basis-[60%] xxl:basis-[50%] text-2xl py-2 lg:px-3"
						ref={containerLeft}
					>
						...
						<div className="flex flex-col gap-10">
							...
							<p className="bg-slate-500 text-white rounded-2xl py-2 px-5 w-fit">
								...
								#ZajednoSmoJači #Prehab #Ridesanum
							</p>
					...
					<div
						className="max-lg:w-full max-xl:w-[70%] xl:max-w-[40%] xl:basis-[40%]  py-2 lg:px-3"
						ref={containerRight}
					>
						<Swiper
