  ...
  return (
    <section className="relative z-20 px-6 pt-16 md:px-10 lg:px-16">
      <div className="grid grid-cols-1 items-stretch gap-4 p-10 max-md:p-0 max-md:pt-10 sm:grid-cols-2 lg:grid-cols-3">
        <div className="border-red_preh_t shadow-black_preh/40 flex h-full flex-col items-center gap-4 rounded-lg border-2 bg-slate-100/80 px-5 py-3 shadow-xl xl:h-[12rem] xl:flex-row xl:justify-between">
        ...
        <div className="border-red_preh_t shadow-black_preh/40 flex h-full w-full flex-col items-center gap-4 rounded-lg border-2 bg-slate-100/80 px-5 py-3 shadow-xl max-lg:col-span-2 max-lg:mx-auto max-lg:w-[45%] max-sm:col-span-1 max-sm:w-full xl:h-[12rem] xl:flex-row xl:justify-between">
