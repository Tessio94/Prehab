...
const ContactForm = ({
  ...
  return (
    <div className="relative mt-5 flex w-full flex-col-reverse items-center justify-center gap-20 bg-slate-100 bg-[url(/images/zadar/slika1.jpg)] bg-cover bg-no-repeat px-10 pt-10 pb-10 sm:flex-row">
