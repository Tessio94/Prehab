...
const Description = () => {
  return (
    // <div className="h-screen w-full py-10 md:px-10 lg:px-16">
    //   <div className="grid gap-10 p-10 2xl:grid-cols-3">
    //     <div className="flex flex-col gap-5">
    //       <div className="bg-red_preh_t/70 w-fit rounded-full p-5">
    //         <Image
    //           src="/images/ikone/massage-table.svg"
    //           className=""
    //           width={40}
    //           height={40}
    //           alt="massage table"
    //         />
    //       </div>
    //       <h3 className="after:bg-red_preh font-oswald relative text-3xl font-semibold after:absolute after:top-[110%] after:left-0 after:h-2 after:w-20 after:rounded-2xl">
    //         Personalizirani pristup terapiji
    //       </h3>
    //       <p className="text-semibold font-inter mt-5 text-2xl text-black">
    ...
    //         <span className="text-red_preh">fizioterapije u Zagrebu</span>. Moje
    //         stručno usavršavanje nikada ne prestaje, te se ponosno mogu
    ...
    //       </p>
    //     </div>
    //     {/* <div className="overflow-hidden rounded-2xl bg-[url(/images/masazni_stol.jpg)]">
    //       <Image
    //         src="/images/masazni_stol.jpg"
    //         className=""
    //         width={497}
